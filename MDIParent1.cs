...
namespace ProyectoBDII
{
    public partial class FormularioPrincipal : Form
    {
        ...
        {
            FormularioAdministracionCliente menu = new FormularioAdministracionCliente();
            menu.Show();
        }

        private void AdmonMedi_Click(object sender, EventArgs e)
        {
            FormularioAdministracionMedicamentos medi = new FormularioAdministracionMedicamentos();
            medi.Show();
        }
